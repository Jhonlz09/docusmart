...
class ajaxSilabos{
    ...
    public function ajaxAgregarSilabos(){ 
        ...
        $silabos = SilabosControlador::ctrAgregarSilabos($this->id_profesor, $this->id_materia, $this->id_horario, $this->id_periodo, $this->id_doc, $this->id_año,$this->capel);
