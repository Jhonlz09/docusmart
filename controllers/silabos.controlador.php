...
class SilabosControlador{
    ...
    static public function ctrAgregarSilabos($id_profesor, $id_materia, $id_horario, $id_periodo, $id_doc, $id_año, $capel){
        
        $silabos = SilabosModelo::mdlAgregarSilabos($id_profesor, $id_materia, $id_horario, $id_periodo, $id_doc, $id_año, $capel);
        return $silabos;
